...
// execute pre_workflow process.
FlowEngine.prototype.pre_workflow = function(cb) {

	var self=this;
	if (self.preWF===-1){return cb();}
	self.seneca.log.debug("workflow")
	var taskList= self.flow.splice(self.preWF,1);
		//execute pre worklow
